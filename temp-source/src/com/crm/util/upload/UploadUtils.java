...
public class UploadUtils {
    ...
    public static String generateFilename() {
        return MONTH_FORMAT.format(new Date()) + RandomStringUtils.random(4, Num62.N36_CHARS);
    }
    ...
    public static String generateFilename(String ext) {
        return MONTH_FORMAT.format(new Date()) + RandomStringUtils.random(4, Num62.N36_CHARS) + "." + ext;
    }
     ...
     * 
     * This method enforces the <code>forceSingleExtension</code> property and then
     * replaces all occurrences of \, /, |, :, ?, *, &quot;, &lt;, &gt;, control
     * chars by _ (underscore).
     * 
     * @param filename
