...
public class PasswordHelper {
    ...
    public void encryptPassword(ManagerEntity dto) {
        ...
        String newPass = new SimpleHash(algorithmName, dto.getPassword(),
                ByteSource.Util.bytes(dto.getAccount() + salt), hashIterations).toHex();
    ...
    public static void main(String[] args) {
        ...
        dto.setPassword("vistabrokers123..");
        dto.setAccount("vistabrokers");
