...
import com.crm.framework.redis.impl.RedisOperatorImpl;
...
public class ManagerCacheAop {
    ...
    public void save(ManagerEntity dto) throws Throwable {
        ...
        redisOperator.hset(SecondLevelCached.SYS_MANAGER_KEY, managerId, JSON.toJSONString(dto),
                SecondLevelCached.CACHED_DB_INDEX);
