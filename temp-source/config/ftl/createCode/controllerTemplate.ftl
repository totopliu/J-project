package com.crm.platform.controller.${upPack};
...
import com.crm.platform.entity.${upPack}.${proClass}Entity;
import com.crm.platform.service.${upPack}.${proClass}Service;
