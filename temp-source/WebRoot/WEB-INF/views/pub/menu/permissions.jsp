...
loadProperties();
$('.stringMenuFirstLevelMenu').html($.i18n.prop('stringMenuFirstLevelMenu'));
$('.stringMenuSecondLevelMenu').html($.i18n.prop('stringMenuSecondLevelMenu'));
$('.stringMenuButton').html($.i18n.prop('stringMenuButton'));
...
function sub() {
  crm.ajax({
    ...
    success: function(json) {
      if (json == "success") {
        layer.confirm($.i18n.prop('stringMenuSuccessfulAssignmentAndClose'),
        function(index) {
          crm.closeWindow();
          return false;
        });
  ...
  <table id="mytable" cellspacing="0" summary="The technical specifications of the Apple PowerMac G5 series">
    <tr>
      <th scope="row" abbr="L2 Cache" class="specalt">
        <span class="stringMenuFirstLevelMenu"></span>
      </th>
      <th scope="row" abbr="L2 Cache" class="specalt">
        <span>
          <span class="stringMenuSecondLevelMenu"></span>
        </span>
        <span style="float: right; margin-right: 150px;">
          <span class="stringMenuButton"></span>
        </span>
      </th>
    </tr>
