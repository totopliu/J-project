  ...
  <div class="main-wrapper">
    <div class="login-wrapper">
      ...
      <form class="form-area" id="form" method="post">
        <input class="input-box " type="text" id="account" name="account" />
        <c:if test="${!empty lg }">
    ...
    <input type="button" class="submit-btn" id="sendVerification" onclick="submitForm()" />
    <div class="go-login">
...
$(function() {
  ...
  $('#sendVerification').attr('value', $.i18n.prop('stringForgetSendVerification'));
